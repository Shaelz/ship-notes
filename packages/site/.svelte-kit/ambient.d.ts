...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_smol_toml: string;
	...
	export const npm_package_devDependencies_undici_types: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_smol_toml: string;
		...
		npm_package_devDependencies_undici_types: string;
